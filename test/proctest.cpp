...
int main() {
    ...
    config.elements.push_back( d );
    channel *c1 = new channel( proc->mem_port, d->port );

    config.elements.push_back( c1 );
    config.elements.push_back( new channel( d->port, proc->mem_port ) );
